document.addEventListener('DOMContentLoaded', async () => {
    ...
    const defaultScheduleFields = document.getElementById('defaultScheduleFields');
    ...
    const defaultDepartureTimeInput = document.getElementById('defaultDepartureTime');
    const customArrivalTimeInput = document.getElementById('customArrivalTime');
    const customDepartureTimeInput = document.getElementById('customDepartureTime');
    ...
    async function startCamera() {
        try {
            ...
            video.addEventListener('error', (err) => {
                ...
                messageElement.textContent = "Kesalahan kamera saat registrasi. Pastikan kamera tidak digunakan aplikasi lain.";
            ...
            messageElement.innerHTML += "<br>-- Kamera tidak digunakan aplikasi lain --";
        }
    }
    ...
    captureButton.addEventListener('click', async () => {
        try {
            ...
            if (!video.readyState || video.readyState < 2) {
                messageElement.textContent = "Kamera belum siap. Harap tunggu beberapa saat.";
            ...
            messageElement.textContent = "Foto berhasil diambil. Silakan daftarkan wajah.";
